...
import EarningInsightsCard from '@/views/dashboards/charts/chart-earning-insights'
import UserOrderCard from '@/views/dashboards/widgets/widget-user-order'
import OrdersCard from '@/views/dashboards/widgets/widget-orders'
import PopularProductCard from '@/views/dashboards/widgets/widget-popular-product'
